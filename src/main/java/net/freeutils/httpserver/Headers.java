...
import static net.freeutils.httpserver.HTTPServer.parseDate;
import static net.freeutils.httpserver.HTTPServer.getBytes;
import static net.freeutils.httpserver.HTTPServer.CRLF;
import static net.freeutils.httpserver.HTTPServer.trimRight;
import static net.freeutils.httpserver.HTTPServer.trimLeft;
