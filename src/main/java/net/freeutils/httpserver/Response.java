...
import static net.freeutils.httpserver.HTTPServer.formatDate;
import static net.freeutils.httpserver.HTTPServer.getBytes;
import static net.freeutils.httpserver.HTTPServer.statuses;
import static net.freeutils.httpserver.HTTPServer.CRLF;
import static net.freeutils.httpserver.HTTPServer.isCompressible;
import static net.freeutils.httpserver.HTTPServer.transfer;
